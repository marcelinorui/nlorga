...
this._wantsPushState=!!this.options.pushState,this._hasPushState=!(!this.history||!this.history.pushState),this._usePushState=this._wantsPushState&&this._hasPushState,this.fragment=this.getFragment(),this.root=("/"+this.root+"/").replace(rootStripper,"/"),this._wantsHashChange&&this._wantsPushState){if(!this._hasPushState&&!this.atRoot()){var root=this.root.slice(0,-1)||"/";return this.location.replace(root+"#"+this.getPath()),!0}this._hasPushState&&this.atRoot()&&this.navigate(this.getHash(),{replace:!0})}if(!this._hasHashChange&&this._wantsHashChange&&!this._usePushState){this.iframe=document.createElement("iframe"),this.iframe.src="javascript:0",this.iframe.style.display="none",this.iframe.tabIndex=-1;var body=document.body,iWindow=body.insertBefore(this.iframe,body.firstChild).contentWindow;iWindow.document.open(),iWindow.document.close(),iWindow.location.hash="#"+this.fragment}var addEventListener=window.addEventListener||function(eventName,listener){return attachEvent("on"+eventName,listener)};return this._usePushState?addEventListener("popstate",this.checkUrl,!1):this._useHashChange&&!this.iframe?addEventListener("hashchange",this.checkUrl,!1):this._wantsHashChange&&(this._checkUrlInterval=setInterval(this.checkUrl,this.interval)),this.options.silent?void 0:this.loadUrl()},stop:function(){var removeEventListener=window.removeEventListener||function(eventName,listener){return detachEvent("on"+eventName,listener)};this._usePushState?removeEventListener("popstate",this.checkUrl,!1):this._useHashChange&&!this.iframe&&removeEventListener("hashchange",this.checkUrl,!1),this.iframe&&(document.body.removeChild(this.iframe),this.iframe=null),this._checkUrlInterval&&clearInterval(this._checkUrlInterval),History.started=!1},route:function(route,callback){this.handlers.unshift({route:route,callback:callback})},checkUrl:function(e){var current=this.getFragment();return current===this.fragment&&this.iframe&&(current=this.getHash(this.iframe.contentWindow)),current===this.fragment?!1:(this.iframe&&this.navigate(current),void this.loadUrl())},loadUrl:function(fragment){return this.matchRoot()?(fragment=this.fragment=this.getFragment(fragment),_.some(this.handlers,function(handler){return handler.route.test(fragment)?(handler.callback(fragment),!0):void 0})):!1},navigate:function(fragment,options){if(!History.started)return!1;options&&options!==!0||(options={trigger:!!options}),fragment=this.getFragment(fragment||"");var root=this.root;(""===fragment||"?"===fragment.charAt(0))&&(root=root.slice(0,-1)||"/");var url=root+fragment;if(fragment=this.decodeFragment(fragment.replace(pathStripper,"")),this.fragment!==fragment){if(this.fragment=fragment,this._usePushState)this.history[options.replace?"replaceState":"pushState"]({},document.title,url);else{if(!this._wantsHashChange)return this.location.assign(url);if(this._updateHash(this.location,fragment,options.replace),this.iframe&&fragment!==this.getHash(this.iframe.contentWindow)){var iWindow=this.iframe.contentWindow;options.replace||(iWindow.document.open(),iWindow.document.close()),this._updateHash(iWindow.location,fragment,options.replace)}}return options.trigger?this.loadUrl(fragment):void 0}},_updateHash:function(location,fragment,replace){if(replace){var href=location.href.replace(/(javascript:|#).*$/,"");location.replace(href+"#"+fragment)}else location.hash="#"+fragment}}),Backbone.history=new History;var extend=function(protoProps,staticProps){var child,parent=this;child=protoProps&&_.has(protoProps,"constructor")?protoProps.constructor:function(){return parent.apply(this,arguments)},_.extend(child,parent,staticProps);var Surrogate=function(){this.constructor=child};return Surrogate.prototype=parent.prototype,child.prototype=new Surrogate,protoProps&&_.extend(child.prototype,protoProps),child.__super__=parent.prototype,child};Model.extend=Collection.extend=Router.extend=View.extend=History.extend=extend;var urlError=function(){throw new Error('A "url" property or function must be specified')},wrapError=function(model,options){var error=options.error;options.error=function(resp){error&&error.call(options.context,model,resp,options),model.trigger("error",model,resp,options)}};return Backbone}),this.NL=this.NL||{},this.NL.Template=this.NL.Template||{},this.NL.Template.OrganizationPartyGuildBounty2=function(obj){obj||(obj={});var __p="";_.escape;with(obj)__p+="";return __p},this.NL.Template.OrganizationPartyGuildBounty3=function(obj){obj||(obj={});var __p="";_.escape;with(obj)__p+="";return __p},this.NL.Template.OrganizationPartyGuildBounty6=function(obj){obj||(obj={});var __p="";_.escape;with(obj)__p+="";return __p},this.NL.Template.OrganizationPartyTeqDefZerg=function(obj){obj||(obj={});var __t,__p="";_.escape,Array.prototype.join;with(obj){var zerg=obj.slice(4);__p+=null==(__t=NL.Template["tequatl-zerg-jobs"](zerg))?"":__t}return __p},this.NL.Template.OrganizationPartyTeqZerg=function(obj){obj||(obj={});var __t,__p="";_.escape,Array.prototype.join;with(obj){var zerg=obj;__p+=null==(__t=NL.Template["tequatl-zerg-jobs"](zerg))?"":__t}return __p},this.NL.Template.TeqZerg=function(obj){obj||(obj={});var __t,__p="";_.escape,Array.prototype.join;with(obj){var guardians=_.where(obj,{profession:"guardian"});if(guardians.length>0){__p+='<br/><div class="row"><div class="col-lg-3"><img src="/img/skills/Wall_of_Reflection.png" /></div>';for(var counter=0,start=0;start<guardians.length-1;){__p+='<div class="col-lg-3">';var group=guardians.slice(start,start+4);start+=group.length,++counter,__p+='<div class="list-group-item active"> Wall '+(null==(__t=counter)?"":__t)+"</div>";for(var i=0;i<group.length;i++)__p+='<div class="list-group-item">'+(null==(__t=group[i].username)?"":__t)+"</div>";__p+="</div>"}__p+="</div>"}var elementalist=_.where(obj,{profession:"elementalist"}),ele_group=elementalist.slice(0,6);ele_group.length>0&&(__p+='<br /><div class="row"><div class="col-lg-3"><img src="/img/skills/Swirling_Winds.png" /></div><div class="col-lg-3"><div class="list-group-item active">Swirling Winds</div>',_.each(ele_group,function(ele,idx){__p+='<div class="list-group-item"><span>SW #'+(null==(__t=idx+1)?"":__t)+'</span><span class="pull-right">'+(null==(__t=ele.username)?"":__t)+"</span></div>"}),__p+="</div></div>");var warrior=_.where(obj,{profession:"warrior"}),war_group=warrior.slice(0,6);war_group.length>0&&(__p+='<br /><div class="row"><div class="col-lg-3"><img src="/img/skills/Battle_Standard.png" /></div><div class="col-lg-3"><div class="list-group-item active">Battle Standard</div>',_.each(war_group,function(war,idx){__p+='<div class="list-group-item"><span>Banner #'+(null==(__t=idx+1)?"":__t)+'</span><span class="pull-right">'+(null==(__t=war.username)?"":__t)+"</span></div>"}),__p+="</div></div>")}return __p},this.NL.Template["admin-accounts-row"]=function(obj){obj||(obj={});var __p="",__e=_.escape;Array.prototype.join;with(obj)__p+="<tr ",obj.enddate&&(__p+='class="text-strikeout"'),__p+=" ><td>"+__e(obj.idlogin)+"</td><td>"+__e(obj.username)+"</td><td>"+__e(obj.displayname)+"</td><td>",1==obj.hascommanderTag&&(__p+='<span class="glyphicon glyphicon-ok text-success"></span>'),__p+="</td><td>",1===obj.idrole?__p+="Guild Member":2===obj.idrole?__p+="Commander":obj.idrole>=3&&(__p+="Administrator"),__p+="</td><td>"+__e(obj.createddate.substring(0,10))+'</td><td><div class="btn-group pull-right"><a href="/admin/account/'+__e(obj.idlogin)+'/edit" role="button" class="btn btn-success btn-sm" ><span class="glyphicon glyphicon-search"></span> Edit</a></div></td></tr>';return __p},this.NL.Template["admin-configurations-row"]=function(obj){obj||(obj={});var __p="",__e=_.escape;Array.prototype.join;with(obj)__p+="<tr><td>"+__e(obj.idpartyconfiguration)+"</td><td>"+__e(obj.description)+"</td><td>",1==obj.pickbanner&&(__p+='<span class="glyphicon glyphicon-ok text-success"></span>'),__p+="</td><td>",1==obj.pickfood&&(__p+='<span class="glyphicon glyphicon-ok text-success"></span>'),__p+="</td><td>",1==obj.pickcommander&&(__p+='<span class="glyphicon glyphicon-ok text-success"></span>'),__p+="</td><td>"+__e(obj.createddate.substring(0,10))+"</td><td>"+__e(obj.updateddate.substring(0,10))+'</td><td><span class="pull-right"><a href="/admin/configuration/'+__e(obj.idpartyconfiguration)+'/edit" role="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-search"></span> Edit</a></span></td></tr>';return __p},this.NL.Template["admin-organization-row"]=function(obj){obj||(obj={});var __p="",__e=_.escape;with(obj)__p+="<tr><td>"+__e(obj[i].idorganization)+"</td><td>"+__e(obj[i].title)+"</td><td>"+__e(obj[i].status)+"</td><td>"+__e(obj[i].description)+"</td><td>"+__e(obj[i].createddate.substring(0,10))+'<td><span class="pull-right"><a href="/commander/organization/'+__e(obj[i].idorganization)+'/edit" role="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-search"></span> Edit</a></span></td></tr>';return __p},this.NL.Template["admin-organizations-row"]=function(obj){obj||(obj={});var __p="",__e=_.escape;with(obj)__p+="<tr><td>"+__e(obj.idorganization)+"</td><td>"+__e(obj.title)+'</td><td><span class="label label-default">'+__e(obj.status)+"</span></td><td>"+__e(obj.description)+"</td><td>"+__e(obj.partialtime)+"</td><td>"+__e(obj.endtime)+"</td><td>"+__e(obj.createddate.substring(0,10))+'<td><span class="pull-right"><a href="/commander/organization/'+__e(obj.idorganization)+'/edit" role="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-search"></span> Edit</a></span></td></tr>';return __p},this.NL.Template["admin-party-configuration-profession"]=function(obj){obj||(obj={});var __t,__p="",__e=_.escape;Array.prototype.join;with(obj)__p+='<h3>Choose Profession Rank</h3><div class="row">',_.each(obj,function(p,idx){__p+='<div class="col-lg-4"><div class="row"><div class="col-lg-offset-3 col-lg-3"><span class="icon-'+__e(p.idprofession)+' big"></span></div><div class="col-lg-4"><input type="text" value="'+(null==(__t=p.rank)?"":__t)+'" data-idx="'+__e(idx)+'" class="form-control text-right rank" /></div></div></div>'}),__p+="</div><br>";return __p},this.NL.Template["admin-party-configuration"]=function(obj){obj||(obj={});var __t,__p="",__e=_.escape;Array.prototype.join;with(obj){__p+='<div class="col-lg-offset-2 col-lg-8"><div class="title"><h2>Edit Configuration <b>'+__e(description)+'</b></h2></div><div class="row"><div class="col-lg-12"><label for="description">Description</label><input type="text" id="description" class="form-control" name="description" placeholder="Description" value=\''+__e(description)+'\'/></div></div><div class="row"><div class="col-lg-12"><label for="jsviewname">View Name</label><select name="jsviewname" id="jsviewname" class="form-control">';var jsviews=["OrganizationPartyTeqZerg","OrganizationPartyTeqDefZerg","OrganizationPartyBounty2","OrganizationPartyBounty3","OrganizationPartyBounty6"];_.each(jsviews,function(jsview){__p+='<option value="'+(null==(__t=jsview)?"":__t)+'" ',jsviewname==jsview&&(__p+="seleted"),__p+=">"+(null==(__t=jsview)?"":__t)+"</option>"}),__p+='</select></div></div><br><h3>Choose what users can pick</h3><div class="row"><div class="col-lg-2"><label for="isAdmin">Pick Banner</label></div><div class="col-lg-2"><input type="checkbox" id="pickbanner" name="pickbanner" data-style="btn-group-sm" ',1==pickbanner&&(__p+="checked"),__p+=' /></div><div class="col-lg-2"><label class="control-label" for="isAdmin">Pick Food</label></div><div class="col-lg-2"><input type="checkbox" id="pickfood" name="pickfood" data-style="btn-group-sm" ',1==pickfood&&(__p+="checked"),__p+='/></div><div class="col-lg-2"><label class="control-label" for="isAdmin">Pick Commander</label></div><div class="col-lg-2"><input type="checkbox" id="pickcommander" name="pickcommander" data-style="btn-group-sm" ',1==pickcommander&&(__p+="checked"),__p+='/></div></div><br><div class="profession"></div><hr><div class="row"><div class="col-lg-12"><div class=" pull-left"><a role="button" href="/admin/configurations" class="btn btn-default"> <span class="glyphicon glyphicon-arrow-left "></span>Back</a></div><div class=" pull-right"><button class="btn btn-primary save"> <span class="glyphicon glyphicon-ok "></span> Save</button></div></div></div></div>'}return __p},this.NL.Template["organization-foodbanner"]=function(obj){obj||(obj={});var __t,__p="";_.escape,Array.prototype.join;with(obj)(foodusername||bannerusername)&&(__p+='<div class="row centered">',foodusername&&(__p+='<div class="col-lg-6"><p class="text-center"><span class="food-icon big"></span> Food will be provided by <b>'+(null==(__t=foodusername)?"":__t)+"</b> </p></div>"),bannerusername&&(__p+='<div class="col-lg-6"><p  class="text-center"><span class="banner-icon big"></span> Banner will be provided by <b>'+(null==(__t=bannerusername)?"":__t)+"</b></p></div>"),__p+="</div>");return __p},this.NL.Template["organization-party"]=function(obj){obj||(obj={});var __p="",__e=_.escape;Array.prototype.join;with(obj)__p+='<div class="row"><div class="col-lg-12"><div class="row">',_.each(partys,function(party,idx){__p+='<div class="col-lg-3"><div class="guild-group"><div class="guild-group-item ',__p+=party.partyname==myparty?"guild-group-item-player-party":"active",__p+='"><b> '+__e(party.partyname)+'</b> <span class="badge">'+__e(party.members.length)+"</span></div>",party.job&&(Array.isArray(party.job)?_.each(party.job,function(job){__p+='<div class="guild-group-item guild-group-item-job"><b>'+__e(job)+"</b></div>"}):__p+='<div class="guild-group-item guild-group-item-job"><b>'+__e(party.job)+"</b></div>"),_.each(party.members,function(member){__p+='<div class="guild-group-item ',member.username==username&&(__p+="guild-group-item-player"),__p+='"><span class="'+__e(member.profession)+'-icon"></span>',member.commander&&(__p+='<span class="'+__e(member.commander)+'-icon"></span>'),1==member.havebanner&&(__p+='<span class="banner-icon"></span>'),1==member.havefood&&(__p+='<span class="food-icon"></span>'),__p+='<span class="user">'+__e(""!=member.displayname?member.displayname:member.username)+"</span></div>"}),__p+='<div class="guild-group-item guild-group-item-join text-center"><span>/join '+__e(party.members[0].username)+"</span></div></div></div>",idx%4==3&&(__p+='</div><div class="row">')}),__p+="</div></div></div>";return __p},this.NL.Template["organization-registry"]=function(obj){obj||(obj={});var __p="",__e=_.escape;Array.prototype.join;with(obj){__p+='<div class="row">';for(var col=0;4>col;col++){var registrys_col=_.select(registrys,function(r,idx){return idx%4==col});__p+='<div class="col-lg-3"><div class="list-group">',_.each(registrys_col,function(r){__p+=r.username==obj.username?'<div class="list-group-item list-group-item-success">':'<div class="list-group-item">',__p+='<span class="'+__e(r.profession)+'-icon"></span>',""!=r.haveTag&&(__p+='<span class="'+__e(r.commander)+'-icon"></span>'),1==r.havebanner&&(__p+='<span class="banner-icon"></span>'),1==r.havefood&&(__p+='<span class="food-icon"></span>'),__p+='<span class="pull-right">'+__e(""!=r.displayname?r.displayname:r.username)+"</span></div>"}),__p+="</div></div>"}__p+="</div>"}return __p},this.NL.Template["organization-statistic"]=function(obj){obj||(obj={});var __t,__p="",__e=_.escape;Array.prototype.join;with(obj){__p+='<br/><div class="row centered">';var sum=0;_.each(obj,function(s){sum+=s.value}),__p+='<div class="col-lg-6"><h4 class="text-center"><b>Participating Players: '+(null==(__t=sum)?"":__t)+'</b></h4></div></div><div class="row centered">',_.each(obj,function(s){__p+='<div class="col-lg-1"><span class="'+__e(s.name)+'-icon"></span><label class="counter">'+__e(s.value)+"</label></div>"}),__p+="</div><br/>"}return __p},this.NL.Template["pager-template"]=function(obj){obj||(obj={});var __t,__p="",__e=_.escape;Array.prototype.join;with(obj){if(__p+='<div class="row"><div class="col-lg-3">',pageCount>0&&(__p+="<span><b>Page "+__e(currentPage)+" of "+__e(pageCount)+"</b></span>"),__p+='</div><div class="col-lg-6 text-center">',pageCount>1){__p+='<nav><ul class="pagination">',currentPage>1&&(__p+='<li><a href="#" data-pager=\''+__e(parseInt(currentPage,10)-1)+'\'><span class="glyphicon glyphicon-menu-left"></span></a></li>');var i=1;for(currentPage>5&&(i=+currentPage-4),1!==i&&(__p+='<li class="disabled"><a href="#">...</a></li>'),i;i<=pageCount;i++)if(__p+=currentPage==i?'<li class="active"><span>'+(null==(__t=i)?"":__t)+' <span class="sr-only">(current)</span></span></li>':'<li><a href="#" data-pager=\''+(null==(__t=i)?"":__t)+"'>"+(null==(__t=i)?"":__t)+"</a></li>",i==+currentPage+4){__p+='<li class="disabled"><a href="#">...</a></li>';break}currentPage!=pageCount&&(__p+='<li><a href="#" data-pager=\''+__e(parseInt(currentPage,10)+1)+'\'><span class="glyphicon glyphicon-menu-right"></span></a></li>'),__p+="</ul></nav>"}__p+='</div><div class="col-lg-3">',pageCount>0&&(__p+='<div class="row"><label class="col-lg-offset-4 col-lg-3"> Items:</label><div class="col-lg-5"><select class="form-control"><option value="10" '+__e(10==itemsPerPage?"selected":"")+' >10</option><option value="25" '+__e(25==itemsPerPage?"selected":"")+' >25</option><option value="50" '+__e(50==itemsPerPage?"selected":"")+' >50</option><option value="100" '+__e(100==itemsPerPage?"selected":"")+" >100</option></select></div></div>"),__p+="</div></div>"}return __p},this.NL.Template["tequatl-zerg-jobs"]=function(obj){obj||(obj={});var __t,__p="";_.escape,Array.prototype.join;with(obj){var zerg=_.chain(obj).pluck("members").flatten().value();__p+='<div class="row">';var guardians=_.where(zerg,{profession:"guardian"});if(guardians.length>0)for(var counter=0,start=0,start=0;start<guardians.length;){__p+='<div class="col-lg-3">';var guard_group=guardians.slice(start,start+4);start+=guard_group.length,++counter,__p+='<div class="guild-group-item guild-group-item-guardian"><b> Wall '+(null==(__t=counter)?"":__t)+'</b> <span class="badge"><b>'+(null==(__t=guard_group.length)?"":__t)+"</b></span></div>";for(var i=0;i<guard_group.length;i++)__p+='<div class="guild-group-item">'+(null==(__t=guard_group[i].username)?"":__t)+"</div>";__p+="</div>"}var warrior=_.where(zerg,{profession:"warrior"}),war_group=warrior.slice(0,6);war_group.length>0&&(__p+='<div class="col-lg-3"><div class="guild-group-item guild-group-item-warrior"><b>Battle Standard</b> <span class="badge"><b>'+(null==(__t=war_group.length)?"":__t)+"</b></span></div>",_.each(war_group,function(war,idx){__p+='<div class="guild-group-item"><span>Banner #'+(null==(__t=idx+1)?"":__t)+'</span><span class="pull-right">'+(null==(__t=war.username)?"":__t)+"</span></div>"}),__p+="</div>");var elementalist=_.where(zerg,{profession:"elementalist"}),ele_group=elementalist.slice(0,6);ele_group.length>0&&(__p+='<div class="col-lg-3"><div class="guild-group-item guild-group-item-elementalist"><b>Swirling Winds</b> <span class="badge"><b>'+(null==(__t=ele_group.length)?"":__t)+"</b></span></div>",_.each(ele_group,function(ele,idx){__p+='<div class="guild-group-item"><span>SW #'+(null==(__t=idx+1)?"":__t)+'</span><span class="pull-right">'+(null==(__t=ele.username)?"":__t)+"</span></div>"}))}return __p},this.NL.Template["user-index"]=function(obj){obj||(obj={});var __p="",__e=_.escape;with(obj)__p+='<div class="col-offset-lg-1 col-lg-3"><div class="thumbnail"><p class="text-center"><b>'+__e(title)+'</b></p><p class="text-center">'+__e(configuration)+'</p><p class="text-center"><span class="label label-success">'+__e(description)+'</span></p><div class="text-center"><span><a href="/user/organization/'+__e(idorganization)+'/view" role="button" class="btn btn-primary btn-sm">Join The Fight</a></span></div></div></div>';return __p},this.NL.Template["user-organization-register"]=function(obj){obj||(obj={});var __t,__p="",__e=_.escape;Array.prototype.join;with(obj){if(__p+='<div class="well"><div class="row"><div class="col-lg-6"><h3 class="text-center">'+__e(""!=obj.user.displayname?obj.user.displayname:obj.user.username)+'</h3></div><div class="col-lg-6"><h3 class="text-center"><b>'+(null==(__t=obj.user.title)?"":__t)+"</b> - "+__e(obj.user.description)+'</h3></div></div><div class="row centered">',2==obj.user.idstatus){__p+='<div class="col-lg-6"><div class="radio-select profession">';for(var i=0;i<obj.userprofessions.length;i++)__p+=registry.idprofession==obj.userprofessions[i].idprofession?'<span class="icon '+__e(obj.userprofessions[i].name)+'-icon big selected" data-input="'+__e(obj.userprofessions[i].idprofession)+'" ><input name="idprofession" value="'+__e(obj.userprofessions[i].idprofession)+'" type="radio" checked /></span>':'<span class="icon '+__e(obj.userprofessions[i].name)+'-icon big" data-input="'+__e(obj.userprofessions[i].idprofession)+'" ><input name="idprofession" value="'+__e(obj.userprofessions[i].idprofession)+'" type="radio" /></span>';if(__p+="</div></div>",1==obj.user.pickbanner&&(__p+='<div class="col-lg-2"><div class="check-select banner">',__p+=1==registry.havebanner?'<span class="icon banner-icon big selected" data-input="ok" ><input type="checkbox" name="havebanner" value="ok" checked /></span>':'<span class="icon banner-icon big" data-input="ok" ><input type="checkbox" name="havebanner" value="ok" /></span>',__p+="</div></div>"),1==obj.user.pickfood&&(__p+='<div class="col-lg-2"><div class="check-select food">',__p+=1==registry.havefood?'<span class="icon food-icon big selected" data-input="ok" ><input type="checkbox" name="havefood"  value="ok" checked /></span>':'<span class="icon food-icon big" data-input="ok" ><input type="checkbox" name="havefood"  value="ok" /></span>',__p+="</div></div>"),1==obj.user.pickcommander){__p+='<div class="col-lg-2"><div class="radio-select commander">';for(var comm=["blue","yellow","purple","red"],i=0;i<comm.length;i++)__p+=registry.haveTag==comm[i]?'<span class="icon '+__e(comm[i])+'-icon big selected" data-input="'+__e(comm[i])+'"><input type="radio" name="havetag" value="'+__e(comm[i])+'" checked/></span>':'<span class="icon '+__e(comm[i])+'-icon big" data-input="'+__e(comm[i])+'"><input type="radio" name="havetag" value="'+__e(comm[i])+'" /></span>';__p+='<span class="icon no-commander-icon big" data-input="" ><input type="radio" name="havetag" value="" /></span></div></div>'}__p+='<div class="col-lg-12"><span class="pull-right"><button class="btn btn-primary">Sign Up For Duty</button></span></div>'}else __p+='<div class="col-lg-2"><div class="profession"><span class="icon '+__e(registry.name)+'-icon big"></span></div></div>',user.pickbanner===!0&&registry.havebanner===!0&&(__p+='<div class="col-lg-2"><div class="banner"><span class="icon banner-icon big"></span></div></div>'),user.pickfood===!0&&registry.havefood===!0&&(__p+='<div class="col-lg-2"><div class="food"><span class="icon food-icon big"></span></div></div>');__p+="</div></div>"}return __p},this.NL.Template["user-organization"]=function(obj){obj||(obj={});var __p="";_.escape;with(obj)__p+='<div class="user-data"></div><div class="registry-data"></div><div class="party-data"></div>';return __p},this.NL.Mixin=this.NL.Mixin||{},this.NL.Model=this.NL.Model||{},this.NL.View=this.NL.View||{},this.NL.Collection=this.NL.Collection||{},this.NL.Router=this.NL.Router||{},toastr.options={closeButton:!1,debug:!1,newestOnTop:!0,progressBar:!1,positionClass:"toast-top-full-width",preventDuplicates:!1,showDuration:"1000",hideDuration:"1000",timeOut:"5000",extendedTimeOut:"1000",showEasing:"swing",hideEasing:"swing",showMethod:"fadeIn",hideMethod:"fadeOut"},NL.Model.OrganizationParty=NL.Model.OrganizationParty||Backbone.Model.extend({defaults:function(){return{partyname:"",members:new NL.Collection.OrganizationPartyMember,jobs:null}}}),NL.Model.OrganizationPartyMember=NL.Model.OrganizationPartyMember||Backbone.Model.extend({defaults:{partyname:"",username:"",displayname:"",profession:"",havebanner:!1,havefood:!1,haveTag:""}}),NL.Model.OrganizationRegistry=NL.Model.OrganizationRegistry||Backbone.Model.extend({idAttribute:"idregistry"}),NL.Model.OrganizationStatus=NL.Model.OrganizationStatus||Backbone.Model.extend({idAttribute:"idorganization",defaults:{idorganization:-1,idstatus:-1},url:function(){return"/api/user/organization/"+this.get("idorganization")+"/status"}}),NL.Model.PartyConfiguration=NL.Model.PartyConfiguration||Backbone.Model.extend({idAttribute:"idpartyconfiguration",defaults:function(){return{idpartyconfiguration:-1,description:"",jsviewname:"",pickfood:!1,pickbanner:!1,pickcommander:!1,createddate:"",updateddate:"",enddate:"",profession:new NL.Collection.PartyConfigurationProfession}},url:function(){return"/api/admin/configuration/"+this.get("idpartyconfiguration")}}),NL.Model.PartyConfigurationProfession=NL.Model.PartyConfigurationProfession||Backbone.Model.extend({idAttribute:"idpartyconfigurationprofession",defaults:{idpartyconfigurationprofession:-1,idpartyconfiguration:-1,idprofession:-1,rank:-1,makeExtraGroup:!1,groupName:"",createddate:"",updateddate:""},url:function(){return"/api/admin/configuration/profession/"+this.get("idpartyconfigurationprofession")}}),NL.Model.Registry=NL.Model.Registry||Backbone.Model.extend({defaults:{idorganization:-1,idregistry:null,idprofession:null,havebanner:!1,havefood:!1,havetag:"",name:""},idAttribute:"idregistry",url:function(){return"/api/user/organization/"+this.get("idorganization")+"/registry"}}),NL.Model.UserIndex=NL.Model.UserIndex||Backbone.Model.extend({url:function(){return"/api/user/organization"},idAttribute:"idorganization"}),NL.Collection.OrganizationParty=NL.Collection.OrganizationParty||Backbone.Collection.extend({model:NL.Model.OrganizationParty,url:function(){return"/api/user/organization/"+this.options.idorganization+"/partys"},defaults:{idorganization:-1,username:""},initialize:function(models,options){this.options=_.extend(this.defaults,options)},setJobs:function(arr){return arr},getMembers:function(){return _.flatten(_.pluck(this.toJSON(),"members"))},getStatistic:function(){return _.sortBy(_.map(_.countBy(this.getMembers(),"profession"),function(count,key){return{name:key,value:count}}),"name")},getFood:function(){var member=_.findWhere(this.getMembers(),{havefood:!0});return member?member.username:null},getBanner:function(){var member=_.findWhere(this.getMembers(),{havebanner:!0});return member?member.username:null},getMyParty:function(){var username=this.options.username,partys=_.select(this.toJSON(),function(p){var myparty=_.select(p.members,function(m){return m.username==username});return myparty.length>0?myparty:void 0});return partys&&partys.length>0?partys[0].partyname:""}}),NL.Collection.OrganizationPartyGuildBounty2=NL.Collection.OrganizationPartyGuildBounty2||NL.Collection.OrganizationParty.extend({setJobs:function(arr){for(var t=0;t<arr.length;t++)arr[t].job=["Target - #"+t%2+1];return arr},parse:function(response){return this.setJobs(response)}}),NL.Collection.OrganizationPartyGuildBounty3=NL.Collection.OrganizationPartyGuildBounty3||NL.Collection.OrganizationParty.extend({setJobs:function(arr){for(var t=0;t<arr.length;t++)arr[t].job=["Target - #"+t%3+1];return arr},parse:function(response){return this.setJobs(response)}}),NL.Collection.OrganizationPartyGuildBounty6=NL.Collection.OrganizationPartyGuildBounty6||NL.Collection.OrganizationParty.extend({setJobs:function(arr){for(var t=0;t<arr.length;t++)arr[t].job=["Target - #"+t%6+1];return arr},parse:function(response){return this.setJobs(response)}}),NL.Collection.OrganizationPartyMember=NL.Collection.OrganizationPartyMember||Backbone.Collection.extend({model:NL.Model.OrganizationPartyMember}),NL.Collection.OrganizationPartyTeqDefZerg=NL.Collection.OrganizationPartyTeqDefZerg||NL.Collection.OrganizationParty.extend({defaults:{defLocations:["East","West","North","MegaLaser"],defJob:["East - Waypoint","East - Shipwreck","West - Beach","West - Shipwreck"],zergBattery:["East","MegaLazer"],defBattery:["North","North","West","West"]},setJobs:function(arr){for(var def=arr.slice(arr.length-4,4),zerg=arr,d=0;d<def.length;d++)def[d].job=[this.options.defJob[d],"Battery Fase - "+this.options.defBattery[d]];for(var z=0;z<zerg.length;z++)zerg[z].job=["Zerg","Battery Fase - "+this.options.zergBattery[z%2]];return def.concat(zerg)},parse:function(response){return this.setJobs(response)}}),NL.Collection.OrganizationPartyTeqZerg=NL.Collection.OrganizationPartyTeqZerg||NL.Collection.OrganizationParty.extend({defaults:{locations:["East","West","North","MegaLaser"]},setJobs:function(arr){for(var i=0;i<arr.length;i++)arr[i].job="Battery Fase - "+this.options.locations[i%this.options.locations.length];return arr},parse:function(response){return this.setJobs(response)}}),NL.Collection.OrganizationRegistry=NL.Collection.OrganizationRegistry||Backbone.Collection.extend({defaults:{idorganization:-1,statistic:[]},model:NL.Model.OrganizationRegistry,url:function(){return"/api/user/organization/"+this.options.idorganization+"/registrys"},initialize:function(models,options){this.options=_.extend(this.defaults,options),this.options.statistic=_.sortBy(_.map(_.countBy(models,"profession"),function(count,key){return{name:key,value:count}}),"name")},parse:function(response){return this.options.statistic=_.sortBy(_.map(_.countBy(response,"profession"),function(count,key){return{name:key,value:count}}),"name"),console.log("."),response},getStatistic:function(){return _.sortBy(_.map(_.countBy(this.toJSON(),"profession"),function(count,key){return{name:key,value:count}}),"name")}}),NL.Collection.Pager=NL.Collection.Pager||Backbone.Collection.extend({initialize:function(options){this.on("collection:data-fetched",this.updatePager,this)},parse:function(response){return this.trigger("collection:data-fetched",response.pager),response.data},changeItemsPerPage:function(itemsPerPage){var self=this;this.pager.currentPage=1,this.pager.itemsPerPage=itemsPerPage,this.fetch().done(function(){self.trigger("collection:updated",self)})},goToPage:function(currentPage){var self=this;this.pager.currentPage=currentPage,this.fetch().done(function(){self.trigger("collection:updated",self)})},fetch:function(options){options=options||{};var data=this.pager;return _.extend(data,this.search),_.extend(options,{data:data}),Backbone.Collection.prototype.fetch.call(this,options)},updatePager:function(pager){this.pager=pager},updateSearch:function(search){this.search=search}}),NL.Collection.PartyConfigurationProfession=NL.Collection.PartyConfigurationProfession||Backbone.Collection.extend({model:NL.Model.PartyConfigurationProfession}),NL.Collection.UserIndex=NL.Collection.UserIndex||Backbone.Collection.extend({model:NL.Model.UserIndex,initialize:function(){this.url="/api/user/organizations"},parse:function(response){return this.trigger("collection:data-fetched",response),response}}),NL.View.AdminOrganization=NL.View.AdminOrganization||Backbone.View.extend({defaults:{timeOutHandler:-1,organization:{},registry:[],partys:[],statistic:[],useroptions:{}},template:NL.Template["user-organization"],initialize:function(options){this.options=_.extend(this.defaults,options),this.model=new NL.Model.OrganizationStatus({idstatus:this.options.organization.idstatus,idorganization:this.options.organization.idorganization}),this.model.on("change",this.statusChange,this),this.render(),this.statusChange(this.model),this.startTimer()},render:function(){this.$el.html(this.template(this.options))},startTimer:function(){var self=this;this.options.timeOutHandler<0&&(this.options.timeOutHandler=setInterval(function(){self.model.fetch({})},1e4))},stopTimer:function(){clearInterval(this.options.timeOutHandler),this.options.timeOutHandler=-1},userModel:function(){return this.options.useroptions.registry?this.options.useroptions.registry:{idorganization:this.options.organization.idorganization}},showUserView:function(save){this.userView=this.userView||new NL.View.UserOrganizationData({el:".user-data",userprofessions:this.options.useroptions.userprofessions,user:this.options.useroptions.user,savebutton:save,model:new NL.Model.Registry(this.userModel())
}),this.userView.showSave(save)},showPartyView:function(stopTimer){this.partyView=this.partyView||new NL.View.OrganizationParty({el:".party-data",partys:this.options.partys,idorganization:this.options.organization.idorganization,username:this.options.useroptions.user.username,jsviewname:this.options.organization.jsviewname}),stopTimer?this.partyView.stopTimer():this.partyView.startTimer()},showRegistryView:function(stopTimer){this.registryView=this.registryView||new NL.View.OrganizationRegistry({el:".registry-data",registry:this.options.registry,username:this.options.useroptions.user.username,idorganization:this.options.organization.idorganization}),stopTimer?this.registryView.stopTimer():this.registryView.startTimer()},removeUserView:function(){this.userView&&this.userView.remove()},removeRegistryView:function(){this.registryView&&this.registryView.remove()},removePartyView:function(){this.partyView&&this.partyView.remove()},statusChange:function(model){console.log("status changed:"+model.get("idstatus"));var status=model.get("idstatus");1==status&&(this.removeUserView(),this.removeRegistryView(),this.removePartyView()),2==status&&(this.showUserView(!0),this.showRegistryView(!1),this.removePartyView()),3==status&&(this.showUserView(!1),this.showRegistryView(!1),this.showPartyView(!1)),4==status&&(this.showUserView(!1),this.showRegistryView(!0),this.showPartyView(!1)),5==status&&(this.showUserView(!1),this.removeRegistryView(),this.showPartyView(!1)),6==status&&(this.showUserView(!1),this.removeRegistryView(),this.showPartyView(!0),this.stopTimer())}}),NL.View.OrganizationParty=NL.View.OrganizationParty||Backbone.View.extend({statisticTemplate:NL.Template["organization-statistic"],template:NL.Template["organization-party"],defaults:{timeOutHandler:-1,idorganization:-1,jsviewname:"",username:"",partys:[]},events:{"click .player":"playerClick"},initialize:function(options){this.options=_.extend(this.defaults,options);var PartyCollection=NL.Collection[this.options.jsviewname];this.collection=new PartyCollection(this.defaults.partys,{idorganization:this.options.idorganization,username:this.options.username}),this.collection.on("reset",this.render,this),0===this.collection.length&&this.collection.fetch({reset:!0}),this.render(),this.startTimer()},render:function(){this.$el.html(""),this.$el.append(this.statisticTemplate(this.collection.getStatistic())),this.$el.append(NL.Template["organization-foodbanner"]({bannerusername:this.collection.getBanner(),foodusername:this.collection.getFood()})),this.$el.append(this.template({partys:this.collection.toJSON(),username:this.collection.options.username,myparty:this.collection.getMyParty()})),this.options.jsviewname&&this.$el.append(NL.Template[this.options.jsviewname](this.collection.toJSON()))},startTimer:function(){var self=this;this.options.timeOutHandler<0&&(this.options.timeOutHandler=setInterval(function(){self.collection.fetch({reset:!0})},1e4))},stopTimer:function(){clearInterval(this.options.timeOutHandler),this.options.timeOutHandler=-1},playerClick:function(e){console.log("Player Click")}}),NL.View.OrganizationRegistry=NL.View.OrganizationRegistry||Backbone.View.extend({statisticTemplate:NL.Template["organization-statistic"],template:NL.Template["organization-registry"],defaults:{timeOutHandler:-1,idorganization:-1,username:"",registry:[]},initialize:function(options){this.options=_.extend(this.defaults,options),this.collection=new NL.Collection.OrganizationRegistry(this.options.registry,{idorganization:this.options.idorganization,username:this.options.username}),this.collection.on("reset",this.render,this),0===this.collection.length&&this.collection.fetch({reset:!0}),this.render(),this.startTimer()},render:function(){this.$el.html(""),this.$el.append(this.statisticTemplate(this.collection.getStatistic())),this.$el.append(this.template({registrys:this.collection.toJSON(),username:this.collection.options.username}))},startTimer:function(){var self=this;this.options.timeOutHandler<0&&(this.options.timeOutHandler=setInterval(function(){self.collection.fetch({reset:!0})},1e4))},stopTimer:function(){clearInterval(this.options.timeOutHandler),this.options.timeOutHandler=-1}}),NL.View.OrganizationStatistic=NL.View.OrganizationStatistic||Backbone.View.extend({template:NL.Template["organization-statistic"],initialize:function(options){this.render()},render:function(){this.$el.html(""),this.$el.html(this.template(this.collection.toJSON()))}}),NL.View.OrganizationUserRegistry=NL.View.OrganizationUserRegistry||Backbone.View.extend({template:NL.Template["user-organization-register"],events:{"click .radio-select span":"radioChange","click .check-select span":"checkboxChange","click button":"buttonClick"},initialize:function(options){this.on("input:change",this.inputChange);var registry=this.model.get("registry");this.model.set("registry",new NL.Model.Registry(registry)),this.render()},render:function(){this.$el.html(""),this.$el.html(this.template(this.model.toJSON()))},radioChange:function(e){var $parent=$(e.currentTarget).parent();$parent.find(".icon.selected").removeClass("selected"),$parent.find('input[type="radio"]').removeAttr("checked");var $target=$(e.currentTarget);$target.addClass("selected");var val=$target.attr("data-input"),$input=$parent.find('input[type="radio"][value="'+val+'"]');$input.attr("checked","checked"),this.trigger("input:change",{name:$input.attr("name"),value:val})},checkboxChange:function(e){var $target=this.$(e.currentTarget),val=$target.attr("data-input"),$input=$target.parent().find('input[type="checkbox"][value="'+val+'"]');$target.hasClass("selected")?($input.removeAttr("checked"),$target.removeClass("selected"),this.trigger("input:change",{name:$input.attr("name"),value:""})):($input.attr("checked","checked"),$target.addClass("selected"),this.trigger("input:change",{name:$input.attr("name"),value:val}))},inputChange:function(obj){var value=obj.value;("havebanner"==obj.name||"havefood"==obj.name)&&(value="ok"==obj.value?!0:!1),"idprofession"==obj.name&&(value=Number(value)),this.model.get("registry").set(obj.name,value)},buttonClick:function(){var self=this;this.model.get("registry").save().done(function(){self.trigger("userregistry:save",self.model.get("registry").toJSON())})}}),NL.View.PagedTable=NL.View.PagedTable||Backbone.View.extend({bodyTemplate:null,footerTemplate:NL.Template["pager-template"],events:{"click ul.pagination li a":"pagerClick","change tfoot select":"itemsPerPageChange"},initialize:function(options){this.bodyTemplate=options.bodyTemplate,this.footerTemplate=options.footerTemplate||this.footerTemplate,this.collection=new NL.Collection.Pager(options.table.data),this.collection.updatePager(options.table.pager),this.collection.updateSearch(options.search),this.collection.url=options.url,this.$table=this.$el.find("table"),this.$header=this.$table.find("thead"),this.$body=this.$table.find("tbody"),this.$footer=this.$table.find("tfoot"),this.columns=this.$header.find("th").length,this.collection.on("collection:updated",this.render,this),this.render(this.collection)},render:function(){this.$body.html("");for(var obj=this.collection.toJSON(),i=0;i<obj.length;i++)this.$body.append(this.bodyTemplate(obj[i]));this.$footer.html('<tr><td colspan="'+this.columns+'">'+this.footerTemplate(this.collection.pager)+"</td></tr>")},pagerClick:function(e,self){e.stopPropagation();var $click=$(e.currentTarget),pagerData=$click.attr("data-pager");pagerData&&this.collection.goToPage(pagerData)},itemsPerPageChange:function(e,self){e.stopPropagation(),this.collection.changeItemsPerPage($(e.currentTarget).find("option:selected").attr("value"))}}),NL.View.PartyConfiguration=NL.View.PartyConfiguration||Backbone.View.extend({template:NL.Template["admin-party-configuration"],collectionTemplate:NL.Template["admin-party-configuration-profession"],className:"row",events:{"click .save":"save","change input.rank":"rankChange"},defaults:{partyconfiguration:null,partyconfigurationprofession:[]},initialize:function(options){this.options=_.extend(this.defaults,options),this.model=new NL.Model.PartyConfiguration(this.options.partyconfiguration),this.collection=new NL.Collection.PartyConfigurationProfession(this.options.partyconfigurationprofession),this.render()},render:function(){this.$el.html(""),this.$el.append(this.template(this.model.toJSON())),this.$el.find(".profession").append(this.collectionTemplate(this.collection.toJSON()))},save:function(){_.each(this.collection.models,function(_model){_model.hasChanged("rank")&&_model.save()}),this.model.set("description",this.$el.find("#description").val()),this.model.set("jsviewname",this.$el.find("#jsviewname").val()),this.model.set("pickbanner",this.$el.find("#pickbanner:checked").length>0?!0:!1),this.model.set("pickfood",this.$el.find("#pickfood:checked").length>0?!0:!1),this.model.set("pickcommander",this.$el.find("#pickcommander:checked").length>0?!0:!1),this.model.save(null,{success:function(){toastr.success("The Configuration was saved succesfully.")}})},rankChange:function(e){var $target=$(e.currentTarget),newRank=$target.val(),idx=$target.attr("data-idx");this.collection.at(idx).set("rank",newRank)},destroy:function(){this.collection.reset(),this.remove()}}),NL.View.PartyStatistic=NL.View.PartyStatistic||Backbone.View.extend({template:null,className:"row centered",initialize:function(options){this.collection=new Backbone.Collection(options.statistic)},render:function(){var self=this;this.$el.html(""),this.collection.foreach(function(elem){self.$el.append(self.template(elem))})},setData:function(statistics){this.collection.reset(statistics)},destroy:function(){this.collection.reset(),this.remove()}}),NL.View.UserIndex=NL.View.UserIndex||Backbone.View.extend({className:"row",timerHandler:null,template:NL.Template["user-index"],initialize:function(){this.collection.on("collection:data-fetched",this.render,this),this.render(),this.startTimer()},render:function(){var self=this;this.$el.html(""),this.collection.forEach(function(model){self.$el.append(self.template(model.toJSON()))})},startTimer:function(){var self=this;this.timerHandler=setInterval(function(){self.collection.fetch()},1e4)},stopTimer:function(){clearTimeout(this.timerHandler)}}),NL.View.UserOrganization=NL.View.UserOrganization||Backbone.View.extend({defaults:{timeOutHandler:-1,organization:{},registry:[],partys:[],statistic:[],useroptions:{}},template:NL.Template["user-organization"],initialize:function(options){this.options=_.extend(this.defaults,options),this.model=new NL.Model.OrganizationStatus({idstatus:this.options.organization.idstatus,idorganization:this.options.organization.idorganization}),this.model.on("change",this.statusChange,this),this.render(),this.statusChange(this.model),this.startTimer()},render:function(){this.$el.html(this.template(this.options))},startTimer:function(){var self=this;this.options.timeOutHandler<0&&(this.options.timeOutHandler=setInterval(function(){self.model.fetch({})},1e4))},stopTimer:function(){clearInterval(this.options.timeOutHandler),this.options.timeOutHandler=-1},userModel:function(){return this.options.useroptions.registry?this.options.useroptions.registry:{idorganization:this.options.organization.idorganization}},showUserView:function(save){this.userView=this.userView||new NL.View.UserOrganizationData({el:".user-data",userprofessions:this.options.useroptions.userprofessions,user:this.options.useroptions.user,savebutton:save,model:new NL.Model.Registry(this.userModel())}),this.userView.showSave(save)},showPartyView:function(stopTimer){this.partyView=this.partyView||new NL.View.OrganizationParty({el:".party-data",partys:this.options.partys,idorganization:this.options.organization.idorganization,username:this.options.useroptions.user.username,jsviewname:this.options.organization.jsviewname}),stopTimer?this.partyView.stopTimer():this.partyView.startTimer()},showRegistryView:function(stopTimer){this.registryView=this.registryView||new NL.View.OrganizationRegistry({el:".registry-data",registry:this.options.registry,username:this.options.useroptions.user.username,idorganization:this.options.organization.idorganization}),stopTimer?this.registryView.stopTimer():this.registryView.startTimer()},removeUserView:function(){this.userView&&this.userView.remove()},removeRegistryView:function(){this.registryView&&this.registryView.remove()},removePartyView:function(){this.partyView&&this.partyView.remove()},statusChange:function(model){console.log("status changed:"+model.get("idstatus"));var status=model.get("idstatus");1==status&&(this.removeUserView(),this.removeRegistryView(),this.removePartyView()),2==status&&(this.showUserView(!0),this.showRegistryView(!1),this.removePartyView()),3==status&&(this.showUserView(!1),this.showRegistryView(!0),this.removePartyView()),4==status&&(this.showUserView(!1),this.showRegistryView(!1),this.removePartyView()),5==status&&(this.showUserView(!1),this.removeRegistryView(),this.showPartyView(!1)),6==status&&(this.showUserView(!1),this.removeRegistryView(),this.showPartyView(!0),this.stopTimer())}}),NL.View.UserOrganizationData=NL.View.UserOrganizationData||Backbone.View.extend({defaults:{userprofessions:[],user:{},savebutton:!1},template:NL.Template["user-organization-register"],events:{"click .radio-select span":"radioChange","click .check-select span":"checkboxChange","click button":"buttonClick"},initialize:function(options){this.options=_.extend(this.defaults,options),this.on("input:change",this.inputChange),this.render()},showSave:function(save){this.options.savebutton=save,this.render()},render:function(){var rend=_.extend(this.options,{registry:this.model.toJSON()});this.$el.html(this.template(rend))},radioChange:function(e){var $parent=$(e.currentTarget).parent();$parent.find(".icon.selected").removeClass("selected"),$parent.find('input[type="radio"]').removeAttr("checked");var $target=$(e.currentTarget);$target.addClass("selected");var val=$target.attr("data-input"),$input=$parent.find('input[type="radio"][value="'+val+'"]');$input.attr("checked","checked"),this.trigger("input:change",{name:$input.attr("name"),value:val})},checkboxChange:function(e){var $target=this.$(e.currentTarget),val=$target.attr("data-input"),$input=$target.parent().find('input[type="checkbox"][value="'+val+'"]');$target.hasClass("selected")?($input.removeAttr("checked"),$target.removeClass("selected"),this.trigger("input:change",{name:$input.attr("name"),value:""})):($input.attr("checked","checked"),$target.addClass("selected"),this.trigger("input:change",{name:$input.attr("name"),value:val}))},inputChange:function(obj){var value=obj.value;("havebanner"==obj.name||"havefood"==obj.name)&&(value="ok"==obj.value?!0:!1),"idprofession"==obj.name&&(value=Number(value)),this.model.set(obj.name,value)},buttonClick:function(){var self=this;this.model.save(null,{success:function(){toastr.success("Registration was successfull.")}}).done(function(){self.trigger("userregistry:save",self.model.toJSON())})}});