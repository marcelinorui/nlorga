...
this["NL"]["Template"]["admin-organizations-row"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<tr><td>' +__e( obj.idorganization ) +'</td><td>' +__e( obj.title ) +'</td><td><span class="label label-default">' +__e( obj.status ) +'</span></td><td>' +__e( obj.description ) +'</td><td>' +__e( obj.partialtime ) +'</td><td>' +__e( obj.endtime ) +'</td><td>' +__e( obj.createddate.substring(0,10) ) +'<td><span class="pull-right"><a href="/commander/organization/' +__e(obj.idorganization) +'/edit" role="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-search"></span> Edit</a></span></td></tr>';}return __p};
...
this["NL"]["Template"]["organization-party"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class="row"><div class="col-lg-12"><div class="row">'; _.each(partys, function(party, idx){ ;__p += '<div class="col-lg-3"><div class="guild-group"><div class="guild-group-item ';if(party.partyname == myparty){;__p += 'guild-group-item-player-party';}else{;__p += 'active';};__p += '"><b> ' +__e( party.partyname ) +'</b> <span class="badge">' +__e( party.members.length) +'</span></div>'; if(party.job){ ; if( Array.isArray(party.job) ){ ;	_.each(party.job, function(job) {;__p += '<div class="guild-group-item guild-group-item-job"><b>' +__e( job ) +'</b></div>'; }) ; } else { ;__p += '<div class="guild-group-item guild-group-item-job"><b>' +__e( party.job ) +'</b></div>'; } ; } ; _.each(party.members,function(member){ ;__p += '<div class="guild-group-item '; if( member.username == username ){;__p += 'guild-group-item-player';};__p += '"><span class="' +__e( member.profession) +'-icon"></span>'; if( member.commander) { ;__p += '<span class="' +__e( member.commander) +'-icon"></span>'; } ; if( member.havebanner == true ) { ;__p += '<span class="banner-icon"></span>'; } ; if( member.havefood == true ) { ;__p += '<span class="food-icon"></span>'; } ;__p += '<span class="user">' +__e( member.displayname != '' ? member.displayname : member.username ) +'</span></div>';});;__p += '<div class="guild-group-item guild-group-item-join text-center"><span>/join ' +__e(party.members[0].username ) +'</span></div></div></div>'; if ( (idx % 4) == 3 ) {;__p += '</div><div class="row">';};});;__p += '</div></div></div>';/*  function SelectText(element) {var doc = document, text = doc.getElementById(element), range, selection;if (doc.body.createTextRange) {range = document.body.createTextRange();range.moveToElementText(text);range.select();} else if (window.getSelection) {selection = window.getSelection();range = document.createRange();range.selectNodeContents(text);selection.removeAllRanges();selection.addRange(range);}}document.onclick = function(e) {if (e.target.className === 'click') {SelectText('selectme');}};*/;}return __p};
...
this["NL"]["Template"]["tequatl-zerg-jobs"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) { var zerg = _.chain(obj).pluck('members').flatten().value() ;__p += '<div class="row">'; var guardians = _.where(zerg, {profession:'guardian'})  ; if (guardians.length > 0) {; var counter = 0 ; var start = 0 ; for(var start = 0; start < guardians.length ;){;__p += '<div class="col-lg-3">';var guard_group = guardians.slice(start,start+ 4 ); start += guard_group.length ;++counter;__p += '<div class="guild-group-item guild-group-item-guardian"><b> Wall ' +((__t = ( counter )) == null ? '' : __t) +'</b> <span class="badge"><b>' +((__t = ( guard_group.length)) == null ? '' : __t) +'</b></span></div>'; for(var i = 0; i < guard_group.length; i++) {;__p += '<div class="guild-group-item">' +((__t = ( guard_group[i].username )) == null ? '' : __t) +'</div>';};__p += '</div>';};}; var warrior = _.where(zerg,{profession:'warrior'}) ; var war_group = warrior.slice(0,6) ; if(war_group.length > 0) {;__p += '<div class="col-lg-3"><div class="guild-group-item guild-group-item-warrior"><b>Battle Standard</b> <span class="badge"><b>' +((__t = ( war_group.length)) == null ? '' : __t) +'</b></span></div>'; _.each(war_group,function(war,idx){;__p += '<div class="guild-group-item"><span>Banner #' +((__t = ( (idx+1) )) == null ? '' : __t) +'</span><span class="pull-right">' +((__t = ( war.username)) == null ? '' : __t) +'</span></div>'; }); ;__p += '</div>'; } ; var elementalist = _.where(zerg,{profession:'elementalist'}) ; var ele_group = elementalist.slice(0, 6) ; if(ele_group.length > 0) {;__p += '<div class="col-lg-3"><div class="guild-group-item guild-group-item-elementalist"><b>Swirling Winds</b> <span class="badge"><b>' +((__t = ( ele_group.length)) == null ? '' : __t) +'</b></span></div>'; _.each(ele_group,function(ele,idx){;__p += '<div class="guild-group-item"><span>SW #' +((__t = ( (idx+1) )) == null ? '' : __t) +'</span><span class="pull-right">' +((__t = ( ele.username)) == null ? '' : __t) +'</span></div>'; }); ; } ;}return __p};
