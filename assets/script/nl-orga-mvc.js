...
this["NL"]["Template"]["organization-party"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) { _.each(obj, function(party){ ;__p += '<div class="col-lg-3"><div class="list-group"><div class="list-group-item active"> ' +__e( party.partyname ) +' <span class="badge">' +__e( party.members.length) +'</span></div><div class="list-group-item">'; _.each(party.members,function(member){ ;__p += '<div class="player"><span class="' +__e( member.profession) +'-icon"></span>'; if( member.commander) { ;__p += '<span class="' +__e( member.commander) +'-icon"></span>'; } ; if( member.havebanner == true ) { ;__p += '<span class="banner-icon"></span>'; } ; if( member.havefood == true ) { ;__p += '<span class="food-icon"></span>'; } ;__p += '<span class="user">' +__e( member.displayname != '' ? member.displayname : member.username ) +'</span></div>';});;__p += '</div><div class="list-group-item list-group-item-info text-center"><span>/join ' +__e(party.members[0].username ) +'</span></div></div></div>';});;}return __p};

this["NL"]["Template"]["organization-registry"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<hr><div class="col-lg-12"><div class="list-group list-group-horizontal">'; _.each(obj,function(r){ ;__p += '<div class="col-lg-3 list-group-item"><span class="' +__e( r.profession) +'-icon"></span>'; if( r.haveTag != '' ) { ;__p += '<span class="' +__e( r.commander) +'-icon"></span>'; } ; if( r.havebanner == true ) { ;__p += '<span class="banner-icon"></span>'; } ; if( r.havefood == true ) { ;__p += '<span class="food-icon"></span>'; } ;__p += '<span class="pull-right">' +__e( r.displayname != '' ? r.displayname : r.username ) +'</span></div>'; }); ;__p += '</div></div>';}return __p};

this["NL"]["Template"]["organization-statistic"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class="row centered">'; _.each(obj,function(s){ ;__p += '<div class="col-lg-1"><span class="' +__e( s.name ) +'-icon"></span><span class="counter">' +__e( s.value ) +'</span></div>'; }); ;__p += '</div>';}return __p};
...
this["NL"]["Template"]["user-index"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class="col-lg-4"><p class="text-center"><b>' +__e( title ) +'</b></p><p class="text-center">' +__e( configuration) +'</p><div class="text-center">'; if ( idstatus == 2  ) {; if ( userInOrganization == 0  ) {;__p += '<span><a href="/user/organization/' +__e(idorganization) +'/register" role="button" class="btn btn-primary">Register</button></a></span>'; } else {;__p += '<span><a href="/user/organization/' +__e(idorganization) +'/view" role="button" class="btn btn-primary">View</button></a></span>'; }; } else { ; if ( idstatus == 3 || idstatus == 4 || idstatus == 5 ) {;__p += '<span><a href="/user/organization/' +__e(idorganization) +'/view" role="button" class="btn btn-primary">View</button></a></span>'; }; };__p += '</div></div>';}return __p};
...
this["NL"]["Template"]["user-organization"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class="user-data"></div><ul class="nav nav-tabs"><li><a data-toggle="tab" href="#registry">Registry</a></li><li><a data-toggle="tab" href="#party">Party</a></li></ul><div class="tab-content" ><div id="user" class=" tab-pane fade"></div><div id="registry" class="tab-pane fade"><div class="statistic-data"></div><div class="registry-data"></div></div><div id="party" class=" tab-pane fade"><div class="statistic-data"></div><div class="party-data"></div></div></div>';}return __p};
...
NL.View.OrganizationParty = NL.View.OrganizationParty || Backbone.View.extend({
	...
	initialize:function(options){
		this.jsviewname = options.jsviewname || null;
		this.render();
	},
	render:function(){
		this.$el.html('');
	...
	renderPartyOptions:function(){
		/*this.$el.append(this.jsviewname);*/
	}	
});
...
NL.View.UserOrganization = NL.View.UserOrganization || Backbone.View.extend({
	...
	renderSubViews: function() {
		...
		this.OrganizationUserRegistryView = new NL.View.OrganizationUserRegistry({
				el: '.user-data',
				model: new Backbone.Model(this.model.get('options'))
			});
			this.OrganizationUserRegistryView.on('userregistry:save', this.saveuserdata, this);
		
		if (idstatus == 2 || idstatus == 3 || idstatus == 4) {
			this.OrganizationStatisticView = new NL.View.OrganizationStatistic({
				el: '.statistic-data',
				collection: new Backbone.Collection(this.model.get('statistic'))
			});
			this.OrganizationRegistryView = new NL.View.OrganizationRegistry({
				el: '.registry-data',
		...
		if (idstatus == 5 || idstatus == 6) {
			...
			this.OrganizationPartyView = new NL.View.OrganizationParty({
				el: '.party-data',
