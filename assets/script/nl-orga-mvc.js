...
this["NL"]["Template"]["admin-organizations-row"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<tr><td>' +__e( obj.idorganization ) +'</td><td>' +__e( obj.title ) +'</td><td>' +__e( obj.status ) +'</td><td>' +__e( obj.description ) +'</td><td>' +__e( obj.createddate.substring(0,10) ) +'<td><span class="pull-right"><a href="/admin/organization/' +__e(obj.idorganization) +'/edit" role="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-search"></span> Edit</a></span></td></tr>';}return __p};

this["NL"]["Template"]["organization-statistic"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class="statistic">'; _.each(statistic,function(s){ ;__p += '<span class="text-center"><span class="' +__e( s.name ) +'-icon"></span><span class="counter">' +__e( s.counter ) +'</span></span>'; }); ;__p += '</div>';}return __p};
...
this["NL"]["Template"]["user-index"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class="col-lg-4"><p class="text-center"><b>' +__e( title ) +'</b></p><p class="text-center">' +__e( configuration) +'</p><div class="text-center">'; if ( idstatus == 2 ) {;__p += '<span><a href="/user/organization/' +__e(idorganization) +'/register" role="button" class="btn btn-primary">Register</button></a></span>'; }; if ( idstatus == 3 || idstatus == 4 || idstatus == 5 ) {;__p += '<span><a href="/user/organization/' +__e(idorganization) +'/view" role="button" class="btn btn-primary">View</button></a></span>'; };__p += '</div></div>';}return __p};
