...
-- Schema nl
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `orga` ;

-- -----------------------------------------------------
-- Schema nl
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `orga` DEFAULT CHARACTER SET utf8 ;
SHOW WARNINGS;
USE `orga` ;
...
CREATE TABLE IF NOT EXISTS `login` (
  ...
  `displayname` VARCHAR(50) NOT NULL COMMENT '',
  `salt` VARCHAR(128) NOT NULL COMMENT '',
  `hascommanderTag` TINYINT(4) NOT NULL COMMENT '',
  `isAdmin` TINYINT(4) NOT NULL COMMENT '',
  ...
  UNIQUE INDEX `uk_username_displayname` (`username` ASC, `displayname` ASC)  COMMENT '')
ENGINE = InnoDB
AUTO_INCREMENT = 89
...
-- -----------------------------------------------------
-- Table `loginprofession`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `loginprofession` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `loginprofession` (
  `idlogin` INT(11) NOT NULL COMMENT '',
  `idprofession` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`idlogin`, `idprofession`)  COMMENT '')
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `organization` (
  `idorganization` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `idpartyconfiguration` INT(11) NOT NULL COMMENT '',
  `idstatus` INT(11) NOT NULL COMMENT '',
  `title` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `createddate` DATETIME NOT NULL COMMENT '',
  `updateddate` DATETIME NOT NULL COMMENT '',
  `enddate` DATETIME NOT NULL COMMENT '',
  PRIMARY KEY (`idorganization`)  COMMENT '')
ENGINE = InnoDB
AUTO_INCREMENT = 4
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `organizationregistry`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `organizationregistry` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `organizationregistry` (
  `idregistry` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `idorganization` INT(11) NOT NULL COMMENT '',
  `idlogin` INT(11) NOT NULL COMMENT '',
  `idprofession` INT(11) NOT NULL COMMENT '',
  `havefood` TINYINT(4) NOT NULL COMMENT '',
  `havebanner` TINYINT(4) NOT NULL COMMENT '',
  `haveTag` VARCHAR(10) NOT NULL COMMENT '',
  `createddate` DATETIME NOT NULL COMMENT '',
  `updateddate` DATETIME NOT NULL COMMENT '',
  PRIMARY KEY (`idregistry`)  COMMENT '',
  INDEX `fk_organizationRegistry_organization` (`idorganization` ASC)  COMMENT '',
  INDEX `fk_organizationRegistry_login` (`idlogin` ASC)  COMMENT '',
  CONSTRAINT `fk_organizationRegistry_login`
    FOREIGN KEY (`idlogin`)
    REFERENCES `login` (`idlogin`),
  CONSTRAINT `fk_organizationRegistry_organization`
...
-- -----------------------------------------------------
-- Table `organizationparty`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `organizationparty` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `organizationparty` (
  `idorganizationparty` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `idorganization` INT(11) NOT NULL COMMENT '',
  `idpartyname` INT(11) NOT NULL COMMENT '',
  `idregistry` INT(11) NOT NULL COMMENT '',
  `havefood` TINYINT(4) NOT NULL COMMENT '',
  `havebanner` TINYINT(4) NOT NULL COMMENT '',
  `createddate` DATETIME NOT NULL COMMENT '',
  PRIMARY KEY (`idorganizationparty`)  COMMENT '',
  INDEX `fk_organizationParty_organization` (`idorganization` ASC)  COMMENT '',
  INDEX `fk_organizationParty_organizationRegistry` (`idregistry` ASC)  COMMENT '',
  CONSTRAINT `fk_organizationParty_organization`
    FOREIGN KEY (`idorganization`)
    REFERENCES `organization` (`idorganization`),
  CONSTRAINT `fk_organizationParty_organizationRegistry`
...
-- -----------------------------------------------------
-- Table `partyconfiguration`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `partyconfiguration` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `partyconfiguration` (
  `idpartyconfiguration` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `description` VARCHAR(255) NOT NULL COMMENT '',
  `jsviewname` VARCHAR(255) NOT NULL COMMENT '',
  `pickfood` TINYINT(4) NOT NULL COMMENT '',
  `pickbanner` TINYINT(4) NOT NULL COMMENT '',
  `pickcommander` TINYINT(4) NOT NULL COMMENT '',
  `createddate` DATETIME NOT NULL COMMENT '',
  `updateddate` DATETIME NOT NULL COMMENT '',
  `enddate` DATETIME NOT NULL COMMENT '',
  PRIMARY KEY (`idpartyconfiguration`)  COMMENT '')
ENGINE = InnoDB
AUTO_INCREMENT = 17
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `profession` (
  `idprofession` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `name` VARCHAR(50) NOT NULL COMMENT '',
  `active` TINYINT(4) NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `partyconfigurationprofession`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `partyconfigurationprofession` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `partyconfigurationprofession` (
  `idpartyconfigurationprofession` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `idpartyconfiguration` INT(11) NOT NULL COMMENT '',
  `idprofession` INT(11) NOT NULL COMMENT '',
  `rank` INT(11) NOT NULL COMMENT '',
  `makeExtraGroup` TINYINT(4) NOT NULL COMMENT '',
  `groupName` VARCHAR(30) NULL DEFAULT NULL COMMENT '',
  `createddate` DATETIME NOT NULL COMMENT '',
  `updateddate` DATETIME NOT NULL COMMENT '',
  PRIMARY KEY (`idpartyconfigurationprofession`)  COMMENT '',
  INDEX `fk_partyConfigurationProfession_profession` (`idprofession` ASC)  COMMENT '',
  INDEX `fk_partyConfigurationProfession_partyConfiguration` (`idpartyconfiguration` ASC)  COMMENT '',
  CONSTRAINT `fk_partyConfigurationProfession_partyConfiguration`
    FOREIGN KEY (`idpartyconfiguration`)
    REFERENCES `partyconfiguration` (`idpartyconfiguration`),
  CONSTRAINT `fk_partyConfigurationProfession_profession`
...
CREATE TABLE IF NOT EXISTS `partyname` (
  `idpartyname` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `name` VARCHAR(200) NOT NULL COMMENT '',
  PRIMARY KEY (`idpartyname`)  COMMENT '')
ENGINE = InnoDB
AUTO_INCREMENT = 40
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- procedure getActiveOrganizations
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure getActivePartyConfiguration
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure getOrganizationForUser
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure getOrganizationStatus
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure getRegistrysForPartys
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure getUserOrganizationConfiguration
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure makeOrganizationPartys
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure moveStatusOrganization
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure populatePartyRegistrys
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure saveConfigurationProfession
-- -----------------------------------------------------
